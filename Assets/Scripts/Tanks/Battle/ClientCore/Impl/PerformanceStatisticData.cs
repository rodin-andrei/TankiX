namespace Tanks.Battle.ClientCore.Impl
{
	public class PerformanceStatisticData
	{
		...
		public int BattleRoundTimeInMin
		{
			get;
			set;
		}

		public int TankCountModa
		{
			get;
			set;
		}
		...
		public int StandardDeviationInMs
		{
			get;
			set;
		}
		...
		public string GraphicDeviceKey
		{
			get;
			set;
		}
		...
		public int RenderResolutionQuality
		{
			get;
			set;
		}
